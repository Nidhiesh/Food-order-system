...
exports.getKolkataTime = getKolkataTime;
exports.getKolkataBusinessDate = getKolkataBusinessDate;
exports.determineShopStatus = determineShopStatus;
...
function getKolkataBusinessDate() {
...
function determineShopStatus(manualClosed, openingTime = "08:00", closingTime = "11:00") {
    if (manualClosed) {
        return {
            isOpen: false,
